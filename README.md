...
```javascript
dayOfYear = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/time-day-of-year@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/time-day-of-year@umd/bundle.js"></script>
```
